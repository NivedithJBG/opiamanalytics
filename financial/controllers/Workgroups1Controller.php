...
class Workgroups1Controller extends \yii\web\Controller
{
    ...
    public function actionSearch()
    {
        ...
        if($projuser)
        {
		    ...
		    $sql="SELECT Workgroup_Id,Project_Id,Name,worktype,unit,quantity FROM workgroups_new WHERE Status='0' ";
			...
			if(count($dataProvider)>0):
                $datarows.='<div class="row wbsheads"><div class="col-md-6 lines">
                                ...
                                <div class="col-md-6 qntittys no-padding">
				...
				foreach($dataProvider AS $key=>$data):
                    ...
                    $datarows.='<div class="row listdats datass" id="workgrouprow'.$data['Workgroup_Id'].'" data-id="'.$data['Workgroup_Id'].'">
                                    ...
                                    <div class="col-md-8 icon-groups">
