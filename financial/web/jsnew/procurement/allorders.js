...
$(document).ready(function(){
  ...
  $(document).on('keyup','.cgsttt',function(){  
    //$('#cgstpurchaseorder').keyup(function() {  alert ("hi");
            ...
            $('.cgsttt').each(function() {
                ...
                // var total = ammtt;
                var tot_price = (subtotal * gst / 100);   
                sum += Number(tot_price);    

                var finaltax= parseFloat(sum).toFixed(2);  
            ...
            var tp=Number(finaltax) + Number(amount);  
            // $('#tax').val(finaltax);
  ...
  $(document).on('keyup','.igsttt',function(){ 
    ...
    //$('#igst').keyup(function(ev) {  
       ...
       // var amount = $('#sub_total').val();
        var igst = $('.igstvalue'+orderID).val(); 
        //var qty = $('#qty').val();
       // var igst = $('#igst').val();
        //$(this).val(); 
