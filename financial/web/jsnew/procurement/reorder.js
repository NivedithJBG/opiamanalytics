...
/*$(document).on( "click", ".addvendortocart", function(){
    ...
    $('.acco-two').addClass('active');

    $('#recollapsecart').addClass('in');

    $("#collapsevendors").attr("aria-expanded","false");

    $("#recollapsecart").attr("aria-expanded","true");

    $('#recollapsecart').css('height','');

    $('.panel-group').removeClass('acco-billofres-active');
    $('.panel-group').removeClass('acco-vendors-active');
    $('.panel-group').addClass('acco-two-active');
...
$(document).on( "click", "#rechooseorder", function(){
    $('#recancelorder').trigger('click');
    $('#recartsearch').trigger('click');
