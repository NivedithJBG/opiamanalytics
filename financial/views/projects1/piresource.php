...
foreach($resourcesadded AS $key=>$data):
    ...
    <input type='hidden' name='piid' value='".$data['Purchase_Id']."'></td>
...
endforeach;
?>
<h1>Purchased Inputs Resources</h1>
<form action="" method="post" id="resourceform">
    <table class="table table-bordered"  >
        <thead>
        <tr>
            <th style="width: 50%"><span class="headings">Purchased Inputs Name</span>
                <input type="text" class="form-control" placeholder="Pi_Name" name="Pi_Name" id="Name" value="<?php echo $datavalue['Name'];?>" readonly="readonly"><span class='error'></span></th>
