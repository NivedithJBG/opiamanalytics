    	...
    	<div class="col-md-12">
		    <div class="panel-group acco-billofres-active" id="accordionindex">
                ...
                ?>
                    ...
                    echo $this->render('materials'); 
                    echo $this->render('direct_labour'); 
                    echo $this->render('sub_contractor'); 
                    echo $this->render('plant_equipment'); 
                    echo $this->render('reporting'); 
                    echo $this->render('orders'); 
                    echo $this->render('despatchorder'); 
                    ?>
