    ...
    <div id="collapsemasteract" class="tab-content cOrder-body panel-collapse collapse">
        <div class="panel-body ">
                    ...
                    <div style="display: none;" class="col-md-3" id="searchestworktypediv" style="display: none;">
                        ...
                        </div><div class="col-md-4"></div><br><br><br><br><br>
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-1 addnext-icon-wrpr">
                                        <div class="icon-groups">
                                            <a style="width: 31px!important;" id="addmoreactivity" class="btn btn-primary icon-add add_estactivity_button small75" href="#"></a>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <label></label>
                                        <button type="button" class="btn btn-danger cancel cancelactivity" id=""><span class="icon-close"></span> Cancel</button>
