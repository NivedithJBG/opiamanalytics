                    ...
                    <div class="search-and-content-wrpr">
                        ...
                        <div class="col-md-12 drctworkorderitem text-center" id="directdis" style="padding-bottom: 20px;">
                            <div class="row drcthead">
                                ...
                                <label style="font-size: 15px;">Direct Work orders</label>
                            </div>
                        ...
                        <div class="content-wrpr" id="newone">
                            ...
                            <div class="edit-form raise-bill-form  row" id="msrll">
                                <div class="preloader" style="display: none;" align="center">
                                    <img src="<?= Yii::$app->request->baseUrl; ?>/images/loader.gif" align="middle">
                                </div>
                            ...
                            <!-- list start here -->
                            <div class="raise-wage-roll-list-wrpr data-content-list rtpdatazz" id="rtpdatazzr">
                                <div class="preloader" style="display: none;" align="center">
                                    <img src="<?= Yii::$app->request->baseUrl; ?>/images/loader.gif" align="middle">
                                </div>
                           ...
                           <!--  </div> -->
                            ...
                            <div class="muster-list-wrpr data-content-list" id="msttems">
                                <div class="preloader" style="display: none;" align="center">
                                    <img src="<?= Yii::$app->request->baseUrl; ?>/images/loader.gif" align="middle">
                                </div>
                        ...
                        <div class="data-content-wagerolllist">
