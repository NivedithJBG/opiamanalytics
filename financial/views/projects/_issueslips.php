<div class="panel panel-default issue-material-slips-tab tab tab-wrapper acco-nine">
            ...
            x--;
			  ...
			  <!-- <input type="radio" class="issueslips" id="rd5" name="rd"> -->		
				<div class="panel-heading" >
				  <h4 class="panel-title" id="issueslips">
					<a data-toggle="collapse" data-parent="#accordionoper" href="#collapseissue">
					<span class="icon-document-text"></span>Issue Slips</a>
				  </h4>
				</div>
        
				<div id="collapseissue" class="tab-content cOrder-body panel-collapse collapse">
				  <div class="panel-body ">
					<div class="search-and-content-wrpr">
						<div class="search-and-actions-wrpr row frstwrapp">
                        ...
                        <div class="search-and-actions-wrpr row secwrapp">
                            <div class="content-search-wrpr col-md-7 col-sm-7 text-left">
