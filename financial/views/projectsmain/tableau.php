...
<script>
  ...
  function go(type){
    if(!$('#dash'+type).html()){
      ...
      /*if(type == 'Estimate')
        var wurl = 'https://prod-apnortheast-a.online.tableau.com/t/opiam/views/<?php echo str_replace(' ', '', ucwords($project->Name)) ?>E/'+type;
      else
        var wurl = 'https://prod-apnortheast-a.online.tableau.com/t/opiam/views/<?php echo str_replace(' ', '', ucwords($project->Name)) ?>/'+type;
       */ 
      ...
      //var wurl = 'https://prod-apnortheast-a.online.tableau.com/t/opiam/views/Plant/Plant';
                          ...
                          <div style="clear:both;padding-left:20px;padding-right:20px;padding-top:20px">
                            <div class="row" style="width:100%;">
                              ...
                              <ul class="nav nav-tabs text-center topsbars">
                                <li class="frstcl" data-toggle="pill"><a   data-toggle="modal" data-target="#dashboardPopup" href="#dashboardPopup" class="resourceTypeTab"  id="resourceSchedule" data-type="Schedule"><span class="icon-schedule"></span> Schedule</a></li> 
                                
                                <li class="frstcl " data-toggle="pill"><a  data-toggle="modal" data-target="#dashboardPopup" href="#dashboardPopup" class="resourceTypeTab" id="resourcePlant" data-type="Plant"><span class="icon-settings2"></span> Plant & Equipment</a></li> 
                                
                                <li data-toggle="pill"><a  data-toggle="modal" data-target="#dashboardPopup" href="#dashboardPopup" class="resourceTypeTab" id="resourcesCost" data-type="Cost"><span class="icon-dollar1"></span> Cost</a></li> 
                                                                
                                <li data-toggle="pill"><a   data-toggle="modal" data-target="#dashboardPopup" href="#dashboardPopup" class="resourceTypeTab"  id="resourcesLabour" data-type="Labour"><span class="icon-tools"></span> Labour</a></li>

                                <li data-toggle="pill"><a data-toggle="modal" data-target="#dashboardPopup" href="#dashboardPopup" class="resourceTypeTab"  id="resourcesSubcontractor" data-type="Subcontractor"><span class="icon-users"></span> Sub Contractor</a></li>

                                <li data-toggle="pill"><a data-toggle="modal" data-target="#dashboardPopup" href="#dashboardPopup" class="resourceTypeTab"  id="resourcesMaterials" data-type="Materials"><span class="icon-truck"></span> Materials</a></li>
                                ...
                                <li data-toggle="pill"><a data-toggle="modal" data-target="#dashboardPopup" href="#dashboardPopup" class="resourceTypeTab" id="resourcesSupport" data-type="Support"><span class="icon-question1"></span> Support</a></li>
                              </ul>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="close dashboardPopup" data-dismiss="modal">×</button>
            </div>

            <!-- Modal body -->
            <div class="modal-body">
               
                            <div class="dashboardView" id="dashSchedule" style="height:100%; width:100%; " ></div>
                            <div class="dashboardView" id="dashPlant" style="height:100%; width:100%; " ></div>
