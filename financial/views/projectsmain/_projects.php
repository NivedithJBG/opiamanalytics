                    ...
                    <div id="collapseprojindex" class="tab-content cOrder-body panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div style="display: none;" id="addwindow" class="add-project-master-form row">
                                <form id="addprojectform">
                                    ...
                                    <div class="col-md-8" >
                                        ...
                                        <div class="col-md-4">
                                            <label></label>
                                            <button style="border-radius: 23px;" type="button" class="btn btn-danger canceladding" id="canceladding"><span class="icon-close"></span> Cancel</button>
                            ...
                            <!-- edit form ends here -->
                                ...
                                <a href="#" class="btn btn-primary addForm" title="Add New Project"><span class="icon-add"></span> Add</a>
