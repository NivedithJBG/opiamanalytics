					...
					<div id="wbs-schedule-header" style="display: none;">
						<div class="search-and-actions-wrpr row head1">
							...
							<div class="content-action-wrpr col-md-10 col-sm-10" id="listscreenshow">
								...
								<a href="#" class="btn btn-primary list-fundreceipt" id="listwbs_schedule"><span class="icon-th-list"></span> List</a>

								<a  href="#" class="btn btn-primary list-fundreceipt schedule_relation-tab reltnmain"><span class="icon-dns"></span> Create Relationships</a>

								<span id="ganttchartshows"></span>
								<input type="hidden" id="mode-edit" name="mode" value="" />
							</div>
							<!--  <div class="content-action-wrpr col-md-3 col-sm-3" id="ganttchartshow2"> 
+                        					</div> -->
						</div>
					</div>
					...
					<div class="content-wrpr">
						...
						<div class="wbs-list-wrpr data-content-list">
							<div class="row">
								<div id="projectnameScheduleWBS" style="display: none;">
									<div class="col-md-12 type project-boq">
										<label id="dispprojectname_schedule"></label>
