          ...
          success: function(data){
            // var items=JSON.parse(data.result);
              ...
              for (i = 0; i < data.result.length; i++) {
                ...
                console.log(item);
                g.AddTaskItem(new JSGantt.TaskItem(item.scheduleitem_id,   item.name,     '',           '',          'ggroupblack',  '', 0, dur,    100,     1,      0,       1,     '',      '',      'Some Notes text', g ));
                $.ajax({
                    type: 'POST',
                    ...
                    success: function(data1){
                      // var items=JSON.parse(data.result);
                        ...
                        for (j = 0; j < data1.result.length; j++) {
                          ...
                          //g.AddTaskItemObject({field1: "test1",field2: "test2",});
