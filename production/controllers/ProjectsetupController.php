...
class ProjectsetupController extends Controller
{
	...
	{  
		...
		if(isset($_POST['activity_id']))
		{
	        ...
	        if($act_qtys = PricingEstimateNew::find()->where(['activity_Id'=>$_POST['activity_id']])->one())
		    	$act_qty = $act_qtys->activity_qty;
	        $act_id = $_POST['activity_id'];
        }
 
		$sql="	SELECT Resource_Id,Name,Unit,fuel_unit,Price,ResourceType_Id,Resource_group_Id,Resource_Location,Vendor_Id,asset_register_item_id 
				FROM resources 
				WHERE Status='0' AND pricing_status=0";
		...
		if($restypeid == 26)//P&M
			$sql .= " AND asset_register_item_id !=0 GROUP BY asset_register_item_id";
		else
			$sql .= " GROUP BY Name";

		$sql.=" ORDER BY Resource_Id DESC, Name DESC";
		...
		if(count($dataProvider)>0):
			...
			foreach($dataProvider AS $key=>$data):
				$sno++;
				$sql1='SELECT Resource_Id,Name,Unit,fuel_unit,Price,ResourceType_Id,Resource_group_Id,Resource_Location,Vendor_Id,rate,consumption,maintenance,machinecost,asset_register_item_id FROM resources WHERE Status="0" AND pricing_status=0 AND Name="'.$data['Name'].'" ';
				if($restypeid!='')
				...
				foreach($childdataProvider AS $childdata):
					...
					if(isset($_POST['mode'])){
						if($restypeid==26){
							...
							$childdatarows.='<div class="row" style="padding:15px 0;">
												<div class="col-md-12 type" style="padding:10px 15px;">
													<div class="col-md-6 machine-radio">
														<label class="radio-inline">
														<input type="radio" id="no_of_hrs" class="pequ-select" checked="checked" name="pequ-select'.$childdata['Resource_Id'].'" value="plant_no_of_hrs" data-resid="'.$childdata['Resource_Id'].'" data-actid="'.$_POST['activity_id'].'">Operation Cost
														</label>
														<label class="radio-inline">
														<input type="radio" id="lease_period" class="pequ-select" name="pequ-select'.$childdata['Resource_Id'].'" data-resid="'.$childdata['Resource_Id'].'" data-actid="'.$_POST['activity_id'].'" value="depreciation">Depreciation
														</label>
													</div>
													<div class="col-md-6">
                                        		...
                                        		$childdatarows.='<option value="Petrol">Petrol</option>
														...
														<div class="col-md-3 type">
									                      <div class="form-group">
									                        ...
									                        <select class="form-control eq_task_multiple_select" data-resid="'.$childdata['Resource_Id'].'" multiple  style="height: 40px;" id="task_id'.$childdata['Resource_Id'].'" >
						...
						elseif($restypeid==24){
							...
							$childdatarows.='<div class="row">
												<div class="col-md-12 type">
													...
													<div class="col-md-6 machine-radio">
														<label class="radio-inline">
													      <input type="radio" id="no_of_hrs" checked="checked" class="equ-select" name="equ-select'.$childdata['Resource_Id'].'" value="no_of_hrs" data-resid="'.$childdata['Resource_Id'].'"  data-actid="'.$_POST['activity_id'].'"> Operation Cost
													    </label>
													    <label class="radio-inline">
													      <input type="radio" id="lease_period" class="equ-select" name="equ-select'.$childdata['Resource_Id'].'" data-resid="'.$childdata['Resource_Id'].'" value="lease_period"  data-actid="'.$_POST['activity_id'].'"> Lease Period
													    </label>
													</div>
												</div>
												...
												<div class="col-md-12">
													<div class="row">
														...
														<div class="col-md-1 type">
															<div class="form-group">
																<label>Quantity</label>
																<input style="text-align: right;" id="estimate-qty'.$childdata['Resource_Id'].'"  data-id='.$childdata['Resource_Id'].' data-qty='.$act_qty.'  type="text" class="form-control estimate-qty" value="" />
															</div>
														</div>
														...
														<div class="col-md-4 type">
															<div class="form-group">
										                        ...
										                        <select class="form-control task_multiple_select" data-resid="'.$childdata['Resource_Id'].'" multiple  style="height: 40px;" id="task_id'.$childdata['Resource_Id'].'" >
										                          <option value="">Select Task</option>
										                          '.$tasklist.'
										                        </select>
						...
						/*elseif($restypeid== 16 || $restypeid== 20 || $restypeid== 21)
						{
													...
													<div class="row">
														...
														<div class="col-md-2 type">
															<div class="form-group">
																...
																<input id="lead_time'.$childdata['Resource_Id'].'" type="text" class="form-control" value="" placeholder="Days"/>
															</div>
														</div>
														<div class="col-md-3 type">
															<div class="form-group">
																<label>Credit Period</label>
																<select id="credit_period'.$childdata['Resource_Id'].'" name="credit_period" class="form-control">
																...
																<span style="font-size:11px; color: red;font-weight: normal;" class="error"></span>
															</div>
														</div>
														<div class="col-md-2 type">
															<div class="form-group">
						...
						if($restypeid==26){
							...
							$childdatarows.='<div class="row">
											...
											<div class="col-md-12 type" style="padding:10px 15px;">
												<div class="col-md-6 machine-radio">
													<label class="radio-inline">
													<input type="radio" id="no_of_hrs" class="mpequ-select" checked="checked" data-type="'.$restypeid.'" name="mpequ-select'.$childdata['Resource_Id'].'" value="mplant_no_of_hrs" data-resid="'.$childdata['Resource_Id'].'">Operation Cost
													</label>
													<label class="radio-inline">
													<input type="radio" id="lease_period" class="mpequ-select" data-type="'.$restypeid.'" name="mpequ-select'.$childdata['Resource_Id'].'" data-resid="'.$childdata['Resource_Id'].'" value="mdepreciation">Depreciation
													</label>
												</div>
												<div class="col-md-6">
													<!-- <span class="c-name">'.$vendorname.'</span> -->
							...
							$childdatarows.='<div class="row">
												<div class="col-md-12 type">
													...
													<div class="col-md-6 machine-radio">
														<label class="radio-inline">
													      <input type="radio" id="no_of_hrs" data-type="'.$restypeid.'" checked="checked" class="mlequ-select" name="mlequ-select'.$childdata['Resource_Id'].'" value="mlno_of_hrs" data-resid="'.$childdata['Resource_Id'].'">Operation Cost
													    </label>
													    <label class="radio-inline">
													      <input type="radio" id="lease_period" data-type="'.$restypeid.'"  class="mlequ-select" name="mlequ-select'.$childdata['Resource_Id'].'" data-resid="'.$childdata['Resource_Id'].'" value="mlease_period">Lease Period
													    </label>
													</div>
												</div>
				...
				if($restypeid==26){//P&M
                  ...
                  $resourceName = $asset_register_item['item_name'];
                }
				else
				...
				$datarows.='<div class="panel-heading">
										  <h4 class="panel-title">
											<a data-toggle="collapse" class="resourceAccordion" data-id="'.$data['Resource_Id'].'" data-parent="#accordionmast" href="#collapseact'.$sno.'">'.($key+1).'.&nbsp;&nbsp;'.$resourceName.'</a>
										  </h4>
										</div>';
				if($key==0)
				{
