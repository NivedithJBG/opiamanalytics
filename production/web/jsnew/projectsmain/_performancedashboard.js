...
function renderCdUnitCostOfActivity(items, actName, actUnit, estQty, schedQty){
    ...
    var svg='<svg width="100%" height="100%" viewBox="0 0 210 134" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMin meet" style="display:block;width:100%;height:auto;">'
        ...
        +'<text x="'+cx+'" y="'+(cy-14)+'" text-anchor="middle" font-size="16" font-weight="700" fill="#1a2540" font-family="Barlow Condensed,Arial">&#8377; '+adjUnitCost.toLocaleString(undefined,{minimumFractionDigits:2,maximumFractionDigits:2})+'</text>'
        +(estQty>0?'<text x="'+cx+'" y="'+(cy+2)+'" text-anchor="middle" font-size="11" font-weight="600" fill="#27ae60" font-family="Barlow Condensed,Arial">&#8377; '+(unitCost*estQty).toLocaleString(undefined,{minimumFractionDigits:2,maximumFractionDigits:2})+'</text>':'')
        ...
        +(an?'<text x="'+cx+'" y="122" text-anchor="middle" font-size="11" fill="#5a6e8c" font-family="Barlow Condensed,Arial">Unit Rate: &#8377; '+fmCost(unitCost)+'</text>':'')
        +(an?'<text x="'+cx+'" y="134" text-anchor="middle" font-size="11" fill="#111" font-family="Barlow Condensed,Arial">'+an+(actUnit?' / '+actUnit:'')+'</text>':'')
        +'</svg>';
