...
function pdShowTasksTip(items, anchor) {
    ...
    if (!items.length) {
        ...
        tip.innerHTML = '<div class="tip-title">Task Productivity</div>'
            + '<div style="display:flex;gap:8px;align-items:flex-end;height:72px;margin-bottom:10px;padding-bottom:4px;border-bottom:1px solid rgba(255,255,255,.12);">' + bars + '</div>'
            + '<table>'
            +   '<thead><tr>'
    ...
    var tipW = Math.round(gpRect.width * 1.3);
