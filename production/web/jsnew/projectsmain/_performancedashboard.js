...
function doTargetProduction(k){
    ...
    var svg='<svg width="100%" height="100%" viewBox="0 0 210 134" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMin meet" style="display:block;width:100%;height:auto;">'
        ...
        +(tq>0?'<text x="105" y="68" text-anchor="middle" font-size="11" fill="#5a6e8c" font-family="Barlow Condensed,Arial">Target</text>':'')
        +(tq>0?'<text x="105" y="82" text-anchor="middle" font-size="16" font-weight="700" fill="#1a2540" font-family="Barlow Condensed,Arial">'+fm(aq>0?aq:tq)+(u?' '+u:'')+'</text>':'')
        +'<text x="105" y="96" text-anchor="middle" font-size="10" fill="#5a6e8c" font-family="Barlow Condensed,Arial">/ '+fm(tq)+(u?' '+u:'')+'</text>'
