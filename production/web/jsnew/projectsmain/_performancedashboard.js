...
function renderActivityCostBars(containerId, items, onRowClick){
    ...
    items.forEach(function(r){
        ...
        if (act === 0) {
            bar = est > 0
                ? '<div class="bs" style="width:100%;background:#546E7A;"></div>'
                : '<div class="bs" style="width:2%;background:#ccc"></div>';
            dispVal = fmtCost(est);
        } else if (act > est) {
            var estPct  = (est / rowMax * 100).toFixed(1);
            var overPct = ((act - est) / rowMax * 100).toFixed(1);
            bar = '<div class="bs" style="width:'+estPct+'%;background:#546E7A;"></div>'
            ...
            bar = '<div class="bs" style="width:'+actPct+'%;background:#546E7A;"></div>'
...
function renderBars(containerId, items, onRowClick){
    ...
    var html = '<div class="leg">'
        +'<span><span class="ld" style="background:#546E7A"></span>Normal</span>'
    ...
    items.forEach(function(r){
        ...
        var barCol = r.critical ? '#00838f' : '#546E7A';
        var rowCls = 'brow';
        var tipLines = [];
...
function doActivityDuration(k) {
    ...
    var baseCol  = k.critical ? '#00838f' : '#546E7A';  // blue if critical, dark grey otherwise
