...
/* DEACTIVATED: duplicate #saveschedule_new handler — posts to wrong controller (projects1, not projectsmain).
   Active handler is in projectsmain/_schedulelist.js → ../projectsmain/schedulecreate
