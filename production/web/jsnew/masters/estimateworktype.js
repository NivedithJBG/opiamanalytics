        ...
        $.ajax({
            ...
            success: function(data){
                if(data.error=='No')
                {
                    ...
                    $('#estworktypeitems table tbody').sortable({
                        placeholder: 'ui-state-highlight',
                        helper: 'clone',
                        update: function(event, ui) {
                            var updatedrows = [];
                            $('#estworktypeitems .projtypes').each(function() {
                                updatedrows.push({ rowid: $(this).data('id'), rowindex: $(this).index() });
                            });
                            $.ajax({ type:'POST', url:'../projects/updateprojecttypesort', data:{datavalue:updatedrows}, dataType:'json', success:function(){} });
                        }
                    }).disableSelection();
                }
