...
$(function() {
    ...
    $(document).on('click', '.add-task-row', function(){
        ...
        var row = '<div class="row task-row" id="task-row-' + taskRowCount + '" style="margin-top:4px;">' +
            ...
            '<div class="col-md-5"><input type="text" class="form-control task-name" name="task_name[]" placeholder="Task Name"></div>' +
            '<div class="col-md-2"><input type="text" class="form-control task-unit" name="task_unit[]" placeholder="Unit"></div>' +
            '<div class="col-md-2"><input type="number" step="0.001" min="0" class="form-control task-productivity" name="task_productivity[]" placeholder="Productivity/Wh"></div>' +
                ...
                if(data.tasks && data.tasks.length > 0){
                    $.each(data.tasks, function(i, task){
                        ...
                        var row = '<div class="row task-row" id="task-row-' + taskRowCount + '" style="margin-top:4px;">' +
                            ...
                            '<div class="col-md-1"></div>' +
                            '<div class="col-md-5"><input type="text" class="form-control task-name" name="task_name[]" placeholder="Task Name" value="' + $('<div/>').text(task.task_name).html() + '"></div>' +
                            ...
                            '<div class="col-md-2"><input type="number" step="0.001" min="0" class="form-control task-productivity" name="task_productivity[]" placeholder="Productivity/Wh" value="' + parseFloat(task.productivity).toFixed(3) + '"></div>' +
