...
body{background:#f0f3fa;font-family:Avenir,'DM Sans',sans-serif;height:100vh;display:flex;flex-direction:column}
...
.cb-msg{max-width:85%;padding:10px 14px;border-radius:14px;font-size:13.3px;line-height:1.6;word-wrap:break-word;font-family:Avenir,'DM Sans',sans-serif}
...
#cb-input{flex:1;border:1px solid #cbd5e1;border-radius:24px;padding:10px 16px;font-size:13.3px;outline:none;font-family:Avenir,'DM Sans',sans-serif}
#cb-input:focus{border-color:#1a2540}
#cb-send{background:#1a2540;color:#fff;border:none;border-radius:24px;padding:10px 20px;font-size:13.3px;font-weight:600;cursor:pointer;white-space:nowrap;font-family:Avenir,'DM Sans',sans-serif}
