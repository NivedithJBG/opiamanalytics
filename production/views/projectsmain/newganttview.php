...
<div id="gantt-toolbar">
    ...
    <a class="icon-tools overNow4 gantt-actlib-btn" title="Activity Library" href="#" style="position:absolute;top:10px;right:42px;z-index:999;width:22px;height:22px;font-size:11px;display:inline-flex;align-items:center;justify-content:center;border-radius:50%;cursor:pointer;text-decoration:none;box-shadow:0 2px 6px rgba(0,0,0,.25);"> </a>
