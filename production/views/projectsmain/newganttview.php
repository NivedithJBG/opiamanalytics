...
<div id="gantt-toolbar">
    ...
    <a class="icon-pencil" id="btn-quick-entry" title="WBS" href="#" style="position:absolute;top:10px;right:16px;z-index:999;width:30px;height:30px;font-size:14px;display:inline-flex;align-items:center;justify-content:center;border-radius:50%;background:#5cb85c;color:#fff;cursor:pointer;text-decoration:none;box-shadow:0 2px 6px rgba(0,0,0,.25);"> </a>
