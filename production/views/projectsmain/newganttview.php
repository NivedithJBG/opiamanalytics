...
<a class="icon-tools" id="btn-actlib-entry" title="Activity Library" href="<?php echo Yii::$app->urlManager->createUrl('projects/projectmasters')?>" onclick="(function(e){e.preventDefault();$('.overNow4').trigger('click');})(event)" style="position:absolute;top:10px;right:44px;z-index:999;width:22px;height:22px;font-size:11px;display:inline-flex;align-items:center;justify-content:center;border-radius:50%;background:#5cb85c;color:#fff;cursor:pointer;text-decoration:none;box-shadow:0 2px 6px rgba(0,0,0,.25);"></a>
...
(function($) {
  ...
  (function() {
    ...
    function _positionCostPopup(anchorEl) {
      ...
      if (left < 4) left = 4;
      var top = rect ? vh * 0.68 - ph * 0.5 : vh / 2 - ph / 2;
