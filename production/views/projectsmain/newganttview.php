...
<a class="icon-tools" id="btn-actlib-entry" title="Activity Library" href="<?php echo Yii::$app->urlManager->createUrl('projects/projectmasters')?>" style="position:absolute;top:10px;right:44px;z-index:999;width:22px;height:22px;font-size:11px;display:inline-flex;align-items:center;justify-content:center;border-radius:50%;background:#5cb85c;color:#fff;cursor:pointer;text-decoration:none;box-shadow:0 2px 6px rgba(0,0,0,.25);"></a>
