                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="projectlocationover" type="text" class="form-control" placeholder="Site location">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <form id="editprojectform">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Location</label>
                                        <input id="editprojectlocation" type="text" class="form-control" placeholder="Site location">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div id="existing_documents" class="mb-1"></div>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="edit_project_documents[]" id="edit_project_documents" multiple accept=".pdf,.doc,.docx,.xls,.xlsx,.jpg,.jpeg,.png">
                                            <label class="custom-file-label" for="edit_project_documents">Add more files</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
