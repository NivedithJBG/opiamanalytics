...
?>
                <div class="panel panel-default WBS-tab acco-three tab tab-wrapper">
				  ...
				  <input type="radio" id="rd5" class="view_workgroups" name="rd">-->
										...
										<div class="wbs-list-wrpr data-content-list">
											<div class="row">
												<div id="projectnameWBS" style="display: none;">
													<div class="col-md-12 type project-boq" style="display:flex;align-items:center;padding:6px 10px;">
														<span style="flex:1;text-align:left;font-size:13px;">Project <em id="dispprojectname"></em></span>
														<span style="flex:1;text-align:center;font-size:14px;font-weight:600;letter-spacing:0.5px;">Items Of Work</span>
					...
					?>
					<div class="modal fade iowFormPopup" id="iowFormPopup" >
					    <div class="modal-dialog modal-lg">
					        <div class="modal-content">
					            ...
					            <div class="modal-header">
					                ...
					                <button type="button" class="close iowFormPopup" data-dismiss="modal" style="float:right; font-size: 30px;">×</button>
					            </div>
												...
												<div class="row">
													...
													<div class="col-md-5">
														<div class="form-group">
															...
															<select class="form-control" id="iowgroupid" name="iowgroupid">
																<option value="">Select IOW Group</option>
																<?php
																if($iowGroups){
																	foreach($iowGroups as $key => $iowGroup) {
														                echo '<option value="'.$iowGroup['id'].'" >'.$iowGroup['name'].'</option>';
														            }
														        }
																?>
															</select>
