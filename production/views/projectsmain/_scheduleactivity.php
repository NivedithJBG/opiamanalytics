...
?>            
                ...
                <script src="<?php echo Yii::$app->request->baseUrl; ?>/jsnew/projectsmain/_wbsscheduleactivity.js?v=<?php echo filemtime(Yii::getAlias('@webroot').'/jsnew/projectsmain/_wbsscheduleactivity.js'); ?>" type="text/javascript"></script>
                            ...
                            <div id="schedule-activity-header" style="display: none;">
                                <div class="search-and-actions-wrpr row" id="schedule-allocate-body-one-head">
                                    ...
                                    <div class="content-action-wrpr col-md-9 col-sm-9" id="actlistingshow">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary" id="savescheduleqty" title="Save quantities from estimate to schedule"><span class="icon-check"></span> SAVE</a>
                                        <?php } ?>
