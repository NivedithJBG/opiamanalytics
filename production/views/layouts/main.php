...
#gantt-win-hdr {
  background:#00838f; color:#fff; padding:18px 15px;
  display:flex; align-items:center; justify-content:space-between;
  cursor:move; user-select:none; flex-shrink:0;
...
<div id="gantt-win">
  ...
  <div id="gantt-win-hdr">
    <div style="display:flex;align-items:baseline;gap:6px;flex-wrap:nowrap;">
      ...
      <span style="font-size:16px;font-weight:500;color:#c9ecef;" id="gantt-win-proj-name"><?php echo htmlspecialchars($ProjectName); ?></span>
    </div>
