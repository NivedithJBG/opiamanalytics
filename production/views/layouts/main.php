...
#pd-tip{position:fixed;z-index:10002;background:#fff;color:#1a2540;font-family:'Barlow Condensed',sans-serif;font-size:12px;line-height:1.7;padding:8px 18px;border-radius:4px;pointer-events:none;display:none;white-space:pre;box-shadow:0 3px 12px rgba(0,0,0,.25);border:1px solid #d8dee8;min-width:220px;}
/* ── Panel ────────────────────────────────────────────────────────────────── */
