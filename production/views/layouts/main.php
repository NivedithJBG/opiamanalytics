...
#cd-g2{overflow-y:auto !important;font-size:13px;}
...
<div id="cd-modal" class="dash-modal">
  ...
  <div id="cd-body">
    <div id="cd-grid">
      ...
      <div class="panel" style="grid-column:2;grid-row:1/span 5"><div class="ph">Cost of Activity</div><div class="pb" id="cd-g2" style="overflow-y:auto;padding:6px 8px"></div></div>
      ...
      <div class="panel" style="grid-column:2;grid-row:6/span 3"><div class="ph">Unit Cost of Activity</div><div class="gp" id="cd-g5"></div></div>
