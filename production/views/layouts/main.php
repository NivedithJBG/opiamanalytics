...
<div id="cd-modal" class="dash-modal">
  ...
  <div id="cd-body">
    <div id="cd-grid">
      <div class="panel" style="grid-column:1;grid-row:1/span 2"><div class="ph">Project Cost</div><div class="pb" id="cd-c2"></div></div>
      <div class="panel" style="grid-column:1;grid-row:3/span 2"><div class="ph">Group Cost</div><div class="pb" id="cd-c1"></div></div>
