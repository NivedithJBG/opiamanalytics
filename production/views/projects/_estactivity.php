    ...
    <div id="collapsemasteract" class="tab-content cOrder-body panel-collapse collapse">
        <div class="panel-body ">
                    ...
                    <div class="search-and-content-wrpr">
                        <div class="search-and-actions-wrpr row" id="AR-allocate-body-one-head" style="display:flex;align-items:center;margin-left:0;margin-right:0;">

                            <div class="content-action-wrpr col-md-8 col-sm-8" style="white-space:nowrap;text-align:left;padding-left:0;">
                            ...
                            <div class="col-md-4 col-sm-4" style="display:flex;justify-content:flex-end;align-items:center;gap:12px;">
