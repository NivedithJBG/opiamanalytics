       ...
       <!-- <div id="menu11" class="tab-pane fade"> -->
          ...
          <div class="search-and-actions-wrpr row" id="shozz">
            ...
            <div class="content-search-wrpr col-md-12 col-sm-12"  style="margin-top: -20px;position: unset;">
                ...
                <li class="active"><a data-toggle="tab" href="#opwrbill" id="wrkbls" style="background: #F5F5F5;"><span class="icon-file3"></span>Work Orders</a></li>
                <li><a data-toggle="tab" href="#oplsbill" id="lskbls" style="background: #F5F5F5;margin: inherit;"><span class="icon-file3"></span>Lease Orders</a></li>
...
<!-- Lease bills -->
            ...
            <div class="content-wrpr leasebillshwng" style="overflow: hidden;display: none;">
              ...
              <div class="lease-orderbill-list-wrpr" style="display:none;">

                  <div class="text-center row wrkbillhead leaebilhdshws" id="leashd" style="margin-left: 15px;margin-right: 15px;margin-bottom: 20px;"><label style="font-size: 15px;">Lease Orders</label></div>
                  <div class="add-form raise-bill-form  row">
                      <div class="preloader" style="display: none;" align="center">
                          <img src="<?= Yii::$app->request->baseUrl; ?>/images/loader.gif" align="middle">
                      </div>                                    
                  ...
                  <div id="" style="padding: 30px 50px;">
              ...
              <div class="leasbillviews row" style="margin-left: 10px;margin-right: 10px; ">
                <form id="lbillssview" method="post">
                    <div id="leasebillitemsview" style="padding: 20px;" ></div>
                </form>
              </div>
              <div class="bilhis row" style="margin-left: 10px;margin-right: 10px; padding-bottom: 30px;">

                <div class="bilhdd data-content-list history-lease-bill-list">
                  <div class="text-center row wrkbillhead"  style="display:none;"  id="leaseorderhistory-wrapper" style="margin-left: 15px;margin-right: 15px;margin-bottom: 20px;"><label style="font-size: 15px;">Lease Bill History</label></div>
                  <div id="leaseorderbillitemshistory"></div>
                </div>

                <div class="row">
                  <div id="leasebillitemhist"></div>
                </div>
