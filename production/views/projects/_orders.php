        ...
        $(document).on( "click","#addmore", function(e){
            ...
            if(x < max_fields){
                $('#issuesliprow').before('<tr><td><span class="number">'+x+'</span></td>' +
                    ...
                    '<td><input type="text" class="form-control invQty" name="invQty[]" id="invQty'+x+'" data-id="'+x+'" placeholder="Inv. Quantity" autocomplete="off">' +
       ...
       <div class="search-and-content-wrpr">
            ...
            <div class="search-and-actions-wrpr row">
                ...
                <div class="content-action-wrpr col-md-2 col-sm-2">
                    ...
                    <a href="#" class="btn btn-primary close-order-history-btn close-material-history-btn" id="clzz"><span class="icon-close"></span> Close Order History</a>
