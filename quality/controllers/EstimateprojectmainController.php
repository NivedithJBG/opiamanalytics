                ...
                /*if($estimateresource['resourcetype_Id']==26){
                    ...
                    $addedones.='<div id="tempresrow'.$estimateresource['pricing_resourceid'].'" class="row estlist">
                                            ...
                                            <div class="col-md-2 icon-groups">
                                                ...
                                                <a data-id="'.$estimateresource['pricing_resourceid'].'" href="javascript:void(0);" title="Delete Resource" class="btn btn-primary rem-res-estimate icon-trash1" '.$reportedstyle.'></a>
                                            </div>
                                        </div>';
