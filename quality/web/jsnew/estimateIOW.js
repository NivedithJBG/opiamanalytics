$(function(){
    ...
    $('#resourcesearch').click(function(){
        ...
        var realProject_Id=$('#realProject_Id').val();

        $.ajax({
            type: 'POST',
            url: '../../EstimateIOW/ResourceSearch',
            beforeSend : function(){
                $('.preloader').show();
            },
            dataType: "json",
            data: {id:id,iowid:$('#Project_Id').val(),resourcename:name,realProject_Id:realProject_Id},
            success: function(data){
                if(data.error=='No')
                {
    ...
    /*$('#logisticssearch').click(function(){
     ...
     $.ajax({
     type: 'POST',
     url: '../../EstimateIOW/LogisticsSearch',
     beforeSend : function(){
     ...
     $.ajax({
     type: 'POST',
     url: '../../EstimateIOW/ActivitiesSearch',
     beforeSend : function(){
     ...
     $.ajax({
     type: 'POST',
     url: '../../EstimateIOW/OverheadSearch',
     beforeSend : function(){
    ...
    $(document).on( "blur",".quantity", function(){
        ...
        $('#'+datatype+'amounttext'+dataid).text(amount.toFixed(2));
        $('#'+datatype+'amount'+dataid).val(amount);
        var totalrate=0;
    ...
    $(document).on('click','.addproduct',function(){
        ...
        var itemid=$('#maxvalue'+selectedid).val();

        if(itemid<quantity)
        {
            $('#productquantity'+selectedid).next("span").html('Exceeds max quantity').show('slow');
            error=1;
        }
...
$(document).on('click','.removeitemadded',function(){
    ...
    if (r == true) {
        $.ajax({
            type: 'POST',
            url: '../../EstimateIOW/deleteactivity',
            beforeSend : function(){
