 ...
 */
$(document).on( "click", "#legaldocuments", function(){
    ...
    $('#legalinboxdocsearch').trigger('click');
    $('#legaloutboxdocsearch').trigger('click');

});

$(document).on( "click", "#legaladddoc", function(){

    var url='../doccumentManager/Createdoc?mode=legal';

    window.location.href = url;
});

$(document).on( "click", "#legaluploaddoc", function(){

    var url='../doccumentManager/Uploaddoc?mode=legal';
...
$(function(){
    $('#legallistddoc').click(function(){
        $('#legalinboxdocsearch').trigger('click');
        $('#legaloutboxdocsearch').trigger('click');
    });
    
    $('#legalinboxdocsearch').click(function(){
        $('#legalarchiveddoclist').slideUp('slow');
        $('#legaldoclistsection').slideDown('slow');// slide down the project listing div
        $('#legallistddoc').removeClass('btn-danger').addClass('btn-success');
        $('#legalarchiveddoc').removeClass('btn-success').addClass('btn-danger');
        $.ajax({
            type: 'POST',
            url: '../DoccumentManager/LegalInboxDocsearch',
            beforeSend : function(){
                $('.preloader').show();
            },
            dataType: "json",
            ...
            success: function(data){
                if(data.error=='No')
                {
                    $('#legaldocitems').html(data.result);
                    $('#legaldoctable').show();
                }
                $('.preloader').hide();
            }
    ...
    $('#legaloutboxdocsearch').click(function(){
        $.ajax({
            type: 'POST',
            url: '../DoccumentManager/LegalOutboxDocsearch',
            dataType: "json",
    ...
    $('#funtiondocsarch').click(function(){
        $('#legalarchiveddoc').trigger('click');
    });
});
...
$(document).on( "click", "#legalarchiveddoc", function(){
    $('#legaldoclistsection').slideUp('slow');
    $('#legalarchiveddoclist').slideDown('slow');
    $('#legalarchiveddoc').removeClass('btn-danger').addClass('btn-success');
    $('#legallistddoc').removeClass('btn-success').addClass('btn-danger');
    $.ajax({

        type: 'POST',

        url: '../DoccumentManager/LegalArchivedDocs',
