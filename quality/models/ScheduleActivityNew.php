...
use Yii;
/**
 * This is the model class for table "schedule_activity_new".
 *
 * The followings are the available columns in table 'schedule_activity_new':
 * @property integer $id
 ...
 */
class ScheduleActivityNew extends \yii\db\ActiveRecord
{
	/**
	 ...
	 * @return ScheduleActivityNew the static model class
	 */
