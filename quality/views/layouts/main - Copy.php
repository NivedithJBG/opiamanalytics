...
<aside class="rightside">
    <div class="col-md-12">
          ...
          <ul class="nav nav-pills nav-stacked">
            ...
            <?php else:?>
                <?php /*if(Yii::$app->user->isAdmin()):*/ if(Yii::$app->user->identity->superuser == 1):?>
...
<div class="header" style="border:0px; display:none;">
    ...
    <nav class="clearfix">
        ...
        <ul class="clearfix">
            ...
            <?php else:?>
                <?php /*if(User::model()->isAdmin()):*/ if(Yii::$app->user->identity->superuser == 1): ?>
                    <!--<li><a href="<?php /*echo Yii::app()->createUrl('projects/index')*/?>">Pricing and Scheduling</a></li>-->
                    <li><a href="<?php echo Yii::$app->urlManager->createUrl('engineering/index')?>">Engineering</a></li>
                    <li><a href="<?php echo Yii::$app->urlManager->createUrl('projects1/index')?>">Projects</a></li>
                    <li><a href="<?php echo Yii::$app->urlManager->createUrl('report/index')?>">Reporting</a></li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="settings"><span class="glyphicon glyphicon-user"></span> <?php echo Yii::$app->user->identity->username;?></a>
