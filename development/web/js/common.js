$(document).ready(function () {
		...
		$('.fund-receipt-tab .addForm').on('click', function(){
			$('.fund-receipt-tab').addClass('addFundReceiptForm-active');
			
		});
		
		$('.add-fund-receipt-form button').on('click', function(){
			$('.fund-receipt-tab').removeClass('addFundReceiptForm-active');
	...
	/* Sep 14 2020 end*/
		...
		$('.btn-send-for-approval').on('click', function(){
