$(document).on( "click", "#LogEquipmentUsage", function(){
    ...
    $(document).on( "click", "#LogEquipmenthead", function(){
        $.ajax({
            type: 'POST',
    ...
    $(document).on( "click", "#Log-head-One", function(){
       ...
       var resgrp = $(this).data("r");
        $.ajax({
                    ...
                    success: function(data){
                        ...
                        {
                            $('#Log-Equipment-list').html(data.result);
                            $('#Log-Equipment-add-form').hide();
                            $('#Log-Equipment-list-log').hide();
                            
                            $('#Log-Equipment-list').show();
                        }
                        $('.preloader').hide();
                    }
            });
    ...
    $(document).on( "click", "#cancelLogBook", function(){
        $('#Log-head-One').trigger('click');
    });



    $(document).on( "click", "#Log-head-Two", function(){
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.error=='No')
                {
                    ...
                    $('#Log-Equipment-add-form').show()
                    $('#Log-Equipment-list').hide()
