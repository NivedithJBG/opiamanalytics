...
/**
 * This is the model class for table "schedule_task_new".
 *
 * The followings are the available columns in table 'schedule_task_new':
 * @property integer $id
 ...
 */
class ScheduleTaskNew extends  \yii\db\ActiveRecord
{
	/**
	 ...
	 * @return ScheduleTaskNew the static model class
	 */
