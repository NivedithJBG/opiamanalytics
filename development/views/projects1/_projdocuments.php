...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/jsnew/projdocument.js" type="text/javascript"></script>
<h2 class="acc_trigger" id="projdocuments"><a href="javascript:void (0)">2. Documents</a></h2>
<div class="acc_container">
    <div class="block">
        <div class="jumbotron">
            <div id="projdoclistsection">
                <div class="row show-grid">
                    <div class="col-md-3" style="text-align: left;">
                        <h4 id="projdocprojectname"></h4>
                        <input type="hidden" name="project_id" id="projprojectid">
                    </div>
                    <div class="col-md-3"><button type="button" class="btn btn-danger"  id="adddoc"><span class="glyphicon glyphicon-plus-sign"></span>Create Document</button></div>
                    <div class="col-md-3"><button type="button" class="btn btn-danger"  id="uploaddoc"><span class="glyphicon glyphicon-plus-sign"></span>Upload Document</button></div>
                ...
                <div id="searchdiv" class="row show-grid" style="display: block;">
                    <div class="col-md-3">
                        <select class="form-control" name="function" id="projfunction">
                    ...
                    <div class="col-md-3">
                        <button id="projdocumentsearch" class="btn btn-primary" type="button" ><span class="glyphicon glyphicon-search"></span>Search</button>
                    </div>
                </div>
                <div class="row show-grid">
                    <!--Table-->
                    <form>
                        <table class="table table-bordered" id="projdoctable" style="display: table; overflow: hidden;">
                            <thead>
                            <tr>
                                <th>Date</th>
                                <th>User</th>
