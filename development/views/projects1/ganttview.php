...
<script type="text/javascript">
// checking the view type is day,weeks or months
...
// if there is holidays the those days will be excluded
...
// these are config values
    ...
    //console.log(task);
    gantt.parse(task);
    /*gantt.attachEvent("onBeforeTaskDisplay", function(id, item){
    ...
    /*gantt.attachEvent("onBeforeLinkAdd", function(id,item){
        ...
        if(source.itemtype=='iow' && target.itemtype=='iow'){
            ...
            alert(itemtarget.priority+' '+itemsource.priority)
            if(itemtarget.priority<itemsource.priority)
            {
                return true;
            }
            else
