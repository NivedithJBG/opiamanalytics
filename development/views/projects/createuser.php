...
<div class="search-and-content-wrpr">
	...
	<div class="content-wrpr" style="overflow-y: unset !important;">
		...
		<div class="finance-type-cntnt-wrpr row">
			...
			<div class="col-md-4 col-sm-4">
				<div class="form-group">
					...
					<select class="form-control" id="account_type" >
						...
						<option value="perfm_pad_access_only">Performance Pad Access Only</option>
						<option value="perfm_pad_access_only">Performance Pad Access Only</option>
						<option value="perfm_pad_reporting_only">Performance Pad Reporting Only</option>
						<option value="project_performance_only">Project Performance Only</option>
					</select>
					<span class="error"></span>
				</div>
			</div>
			...
			<div class="col-md-6 col-sm-6 text-right" style="padding-bottom: 20px;">
