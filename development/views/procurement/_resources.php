				...
				<div class="search-and-content-wrpr">
                    <div class="search-and-actions-wrpr row" style="padding-bottom:0px;">
						...
						<div class="content-action-wrpr col-md-3 col-sm-3">
							...
							<button type="button" class="btn btn-primary addResourceGroupForm" id="res_groups" style="width:auto;" data-toggle="modal" data-target="#resourceGroupPopup" href="#resourceGroupPopup">Resource Groups</button>


							<button type="button" class="btn btn-primary addForm" id="addresources" title="Add Resource" style="width:auto;"><span class="icon-add"></span> Add Resource</button>
									...
									<div class="col-md-1"></div>
										<div class="col-md-10">
											<div class="row">
												...
												<div class="row asset_reg_row" style="display:none;">
													<div class="col-md-4">
													...
													<div class="col-md-2">
														...
														<input class="form-control" type="text" id="purchase_date" name="purchase_date" placeholder="Date of Purchase" tabindex="2">
													</div>
													<div class="col-md-2">
														<label>Registration Number<span style="color:red;"> *</span></label>
														<input class="form-control" type="text" id="reg_number" name="reg_number" placeholder="Registration Number" tabindex="2">
														<span class="error" style="display: none;"></span>
													</div>
													<div class="col-md-2">
														<label>Identification Number<span style="color:red;"> *</span></label>
														<input class="form-control" type="text" id="id_number" name="id_number" placeholder="Identification Number" tabindex="2">
														<span class="error" style="display: none;"></span>
													</div>
													<div class="col-md-2">
														<label>Capacity<span style="color:red;"> *</span></label>
														<input class="form-control" type="text" id="capacity" name="capacity" placeholder="Capacity" tabindex="2">
														<span class="error" style="display: none;"></span>
													</div>
												...
												<div class="col-md-4">
													...
													<div class="form-group" id="rsgrpshow" style="display:none;">
							                            ...
							                            <select id="resgroup" class="form-control">
							                            	...
							                            	<option data-eq-type="engine" value="102">Engine Driven Equipments </option>
							                            	<option data-eq-type="motor" value="154">Motor Driven Equipments</option>
							                            </select>
													...
													<div class="form-group">
														...
														<input class="form-control" id="lead_time" name="lead_time" placeholder="Enter Lead Time" type="text" />
													</div>
												...
												<div class="col-md-4">
													...
													<div class="row equipmentdetails" style="display:none;">
						                    			<div class="col-md-6 no-left-padding" id="pownam">
						                            		<div class="form-group">
						                        		...
						                        		<div class="col-md-6 no-right-padding" id="dirate">
						                            		<div class="form-group">
												...
												<div class="col-md-4">
										  			...
										  			<div class="row">
														...
														<div class="col-md-4 schedulediv no-right-padding" style="display:none;">    
														    <div class="row">
