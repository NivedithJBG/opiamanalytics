<div class="panel panel-default resource acco-two tab tab-wrapper">
    ...
    <div class="panel-heading" >
        ...
        <h4 class="panel-title acc_trigger projectresources">
            <a data-toggle="collapse" data-parent="#accordionproreports" href="#collapseresrep">
            <span class="icon-note1 acc_trigger"></span>Project Resource Report</a>
        </h4>
    </div>
    <div id="collapseresrep" class="tab-content cOrder-body panel-collapse collapse">
